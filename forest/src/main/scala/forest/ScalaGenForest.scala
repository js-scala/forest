...
trait ScalaGenForestPkg extends ScalaGenForest with ScalaGenIfThenElse with ScalaGenListOps with ScalaGenStringOps with ScalaGenObjectOps with ScalaGenProxy with ScalaGenModules with ScalaGenStruct {
  val IR: ForestPkgExp
}
